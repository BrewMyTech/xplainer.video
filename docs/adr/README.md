...
| [0013](0013-plugin-packaging-for-claude-and-codex.md) | `xplainer mcp` is real, so half of that record's submission bar is discharged; the other half is the publish, and both bundles declare `npx -y @xplainer/cli mcp` |
